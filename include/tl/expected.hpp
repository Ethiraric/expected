...
public:
  ...
  TL_EXPECTED_11_CONSTEXPR auto and_then_with(F &&f, Args &&... args) & {
    return and_then_with_impl(*this, std::forward<F>(f),
  ...
  template <class F, class... Args>
  constexpr auto and_then_with(F &&f, Args &&... args) const & {
    return and_then_with_impl(*this, std::forward<F>(f),
                              std::forward<Args>(args)...);
  }
  ...
  template <class F, class... Args>
  TL_EXPECTED_11_CONSTEXPR auto
  and_then_with(F &&f, Args &&... args) & -> decltype(
      and_then_with_impl(std::declval<expected &>(), std::forward<F>(f),
                         std::forward<Args>(args)...)) {
    return and_then_with_impl(*this, std::forward<F>(f),
                              std::forward<Args>(args)...);
  }
  ...
  and_then_with(F &&f, Args &&... args) && -> decltype(
      and_then_with_impl(std::declval<expected &&>(), std::forward<F>(f),
                         std::forward<Args>(args)...)) {
    return and_then_with_impl(std::move(*this), std::forward<F>(f),
                              std::forward<Args>(args)...);
  }
  template <class F, class... Args>
  constexpr auto and_then_with(F &&f, Args &&... args) const & -> decltype(
      and_then_with_impl(std::declval<expected const &>(), std::forward<F>(f),
                         std::forward<Args>(args)...)) {
    return and_then_with_impl(*this, std::forward<F>(f),
                              std::forward<Args>(args)...);
  }
  ...
  transform(F &&f) const && {
    ...
    !defined(TL_EXPECTED_GCC54) && !defined(TL_EXPECTED_GCC55)
  template <class F, class... Args>
  TL_EXPECTED_11_CONSTEXPR auto pass_through(F &&f, Args &&... args) & {
    return expected_pass_through_impl(*this, std::forward<F>(f),
                                      std::forward<Args>(args)...);
  }
  template <class F, class... Args>
  TL_EXPECTED_11_CONSTEXPR auto pass_through(F &&f, Args &&... args) && {
    return expected_pass_through_impl(std::move(*this), std::forward<F>(f),
                                      std::forward<Args>(args)...);
  }
  template <class F, class... Args>
  constexpr auto pass_through(F &&f, Args &&... args) const & {
    return expected_pass_through_impl(*this, std::forward<F>(f),
                                      std::forward<Args>(args)...);
  }
  template <class F, class... Args>
...
#else
  template <class F, class... Args>
  TL_EXPECTED_11_CONSTEXPR decltype(expected_pass_through_impl(
      std::declval<expected &>(), std::declval<F &&>(),
      std::declval<Args &&>()...))
  pass_through(F &&f, Args &&... args) & {
    return expected_pass_through_impl(*this, std::forward<F>(f),
                                      std::forward<Args>(args)...);
  }
  template <class F, class... Args>
  TL_EXPECTED_11_CONSTEXPR decltype(
      expected_pass_through_impl(std::declval<expected>(), std::declval<F &&>(),
                                 std::declval<Args &&>()...))
  pass_through(F &&f, Args &&... args) && {
    return expected_pass_through_impl(std::move(*this), std::forward<F>(f),
                                      std::forward<Args>(args)...);
  ...
  template <class F, class... Args>
  constexpr decltype(
      expected_pass_through_impl(std::declval<const expected &>(),
                                 std::declval<F &&>(), std::declval<Args>()...))
  pass_through(F &&f, Args &&... args) const & {
    return expected_pass_through_impl(*this, std::forward<F>(f),
                                      std::forward<Args>(args)...);
  }
...
#ifndef TL_EXPECTED_NO_CONSTRR
  template <class F, class... Args>
  constexpr decltype(expected_pass_through_impl(
  ...
  template <class F> expected constexpr or_else(F &&f) const && {
    ...
    !defined(TL_EXPECTED_GCC54) && !defined(TL_EXPECTED_GCC55)
  template <class F, class... Args>
  TL_EXPECTED_11_CONSTEXPR auto map_error_with(F &&f, Args &&... args) & {
    return map_error_with_impl(*this, std::forward<F>(f),
                               std::forward<Args>(args)...);
  }
  template <class F, class... Args>
  TL_EXPECTED_11_CONSTEXPR auto map_error_with(F &&f, Args &&... args) && {
    return map_error_with_impl(std::move(*this), std::forward<F>(f),
                               std::forward<Args>(args)...);
  }
  template <class F, class... Args>
  constexpr auto map_error_with(F &&f, Args &&... args) const & {
    return map_error_with_impl(*this, std::forward<F>(f),
                               std::forward<Args>(args)...);
  }
  template <class F, class... Args>
  ...
  template <class F, class... Args>
  TL_EXPECTED_11_CONSTEXPR decltype(
      map_error_with_impl(std::declval<expected &>(), std::declval<F &&>(),
                          std::declval<Args &&>()...))
  map_error_with(F &&f, Args &&... args) & {
    return map_error_with_impl(*this, std::forward<F>(f),
                               std::forward<Args>(args)...);
  }
  template <class F, class... Args>
  ...
  template <class F, class... Args>
  constexpr decltype(map_error_with_impl(std::declval<const expected &>(),
                                         std::declval<F &&>(),
                                         std::declval<Args &&>()...))
  map_error_with(F &&f, Args &&... args) const & {
    return map_error_with_impl(*this, std::forward<F>(f),
                               std::forward<Args>(args)...);
  }
...
template <class Exp, class F,
          detail::enable_if_t<!std::is_void<exp_t<Exp>>::value> * = nullptr,
          class... Args>
constexpr auto and_then_with_impl(Exp &&exp, F &&f, Args &&... args) {
  using Ret = decltype(detail::invoke(
      std::declval<F>(), std::declval<Args>()..., *std::declval<Exp>()));
  static_assert(detail::is_expected<Ret>::value, "F must return an expected");
...
template <class Exp, class F,
          detail::enable_if_t<!std::is_void<exp_t<Exp>>::value> * = nullptr,
          class... Args>
auto and_then_with_impl(Exp &&exp, F &&f, Args &&... args)
    -> decltype(detail::invoke(std::declval<F>(), std::declval<Args>()...,
                               *std::declval<Exp>())) {
  using Ret = decltype(detail::invoke(
      std::declval<F>(), std::declval<Args>()..., *std::declval<Exp>()));
...
auto expected_pass_through_impl(Exp &&exp, F &&f, Args &&... args) {
  ...
  static_assert(std::is_void<Ret>::value,
                "pass_through callable must return void. Use map otherwise.");
  using result = detail::decay_t<Exp>;
  if (exp.has_value()) {
    detail::invoke(std::forward<F>(f), std::forward<Args>(args)..., *exp);
...
template <class Exp, class F, class... Args,
          ...
          class Ret = decltype(detail::invoke(std::declval<F>(),
                                              ...
                                              std::declval<Exp>().error())),
          detail::enable_if_t<!std::is_void<Ret>::value> * = nullptr>
constexpr auto map_error_with_impl(Exp &&exp, F &&f, Args &&... args) {
  using result = expected<exp_t<Exp>, detail::decay_t<Ret>>;
  return exp.has_value()
             ? result(*std::forward<Exp>(exp))
             : result(unexpect, detail::invoke(std::forward<F>(f),
...
template <class Exp, class F, class... Args,
          ...
          class Ret = decltype(detail::invoke(std::declval<F>(),
                                              ...
                                              std::declval<Exp>().error())),
          detail::enable_if_t<std::is_void<Ret>::value> * = nullptr>
auto map_error_with_impl(Exp &&exp, F &&f, Args &&... args) {
  using result = expected<exp_t<Exp>, monostate>;
  if (exp.has_value()) {
    return result(*std::forward<Exp>(exp));
  }
